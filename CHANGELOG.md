...
### Removed
- Remove which-key.nvim, nvim-cmp and its source plugins, manual `packadd` calls, and duplicate Vimscript filetype detectors.
- Remove automatic format on save (manual formatting remains available with `<leader>cf`).
