...
map("<leader>h", function() require("health").run() end, "Health check")
...
map("<leader>pf", function() require("sfcc").controller_picker() end, "Find SFCC controller")
map("<leader>pi", function() require("sfcc").template_picker() end, "Find ISML template")
map("<leader>pl", function() require("sfcc").view_logs() end, "View SFCC logs")
map("<leader>pr", function() require("sfcc").refresh_controllers() end, "Refresh SFCC controllers")
